...
(after! embark
  ...
  (map! :map embark-org-ref-cite-map
        "o" (lambda (&optional _) (funcall org-ref-open-citation-at-point))
        "p" (lambda (&optional _) (funcall org-ref-open-pdf-function))
        ...
        "k" (λ! (progn (kill-new (car (org-ref-get-bibtex-key-and-file)))))
        "f" (λ! (kill-new (org-ref-format-entry (org-ref-get-bibtex-key-under-cursor))))
        "e" (λ! (kill-new (save-excursion (org-ref-open-citation-at-point) (org-ref-email-bibtex-entry))))
        "i" (lambda (&optional _) (funcall org-ref-insert-cite-function))
  ...
  (map! :map embark-org-ref-ref-map
        "i" (lambda () (funcall org-ref-insert-ref-function))
        "h" (lambda (&optional _) (call-interactively #'org-ref-change-ref-type)))

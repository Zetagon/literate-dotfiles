...
(add-to-list 'evil-normal-state-modes 'git-branchless-smartlog-mode)
(map! (:mode git-branchless-smartlog-mode
       :n "L" #'git-branchless-smartlog-magit-log
       :n "S" #'git-branchless-smartlog-switch
       :n "RET" #'git-branchless-smartlog-magit-show-commit)
      (:leader
       (:prefix "g"

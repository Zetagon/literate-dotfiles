...
I'll also try visitng a random node on startup.
#+begin_src emacs-lisp
(add-to-list 'doom-init-ui-hook #'org-roam-node-random t)
#+end_src
...
(setq org-publish-project-alist
      '(("micro-blog"
         :author ""
         :base-directory "~/Documents/blog/content/org/"
         :base-extension "org"
         :publishing-function ((lambda (plist filename pub-dir)
                                 (org-publish-org-to 'hugo filename ".md" plist pub-dir))
                               org-rss-publish-to-rss)
         :publishing-directory "~/Documents/blog/content/rss"
         :section-numbers nil
         :with-toc nil
         :hugo-custom-front-matter ":tags \"\" :title \"Link Blog\" :comments false :useDate false"
         )))

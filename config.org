...
#+begin_src emacs-lisp
(after!
  (defadvice! my/embark-target-url-at-point (fun)
    :around #'embark-target-url-at-point
    (my/foo fun))
  (defun my/foo (fun)
    (save-excursion
      (let* ((beg (progn (skip-chars-backward "[:alnum:]*_\\-:") (point)))
             ...
             (cite-type (cl-second (s-match "^\\([[:alpha:]\*]+\\):" str))))

        (cond ((-contains? org-ref-cite-types
                           cite-type)
               `(org-ref-cite . ,str))
              ((-contains? org-ref-ref-types
                           cite-type)
               `(org-ref-ref . ,str))
              (t
               (funcall fun)))))
  ...
  (add-to-list 'embark-keymap-alist '(org-ref-cite . embark-org-ref-cite-map))
  (add-to-list 'embark-keymap-alist '(org-ref-ref . embark-org-ref-ref-map)))
#+end_src

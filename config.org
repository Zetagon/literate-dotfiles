...
(defvar my/dailyreview-secretary
  (list
      (make-el-secretario-source
       :init-function  (lambda () (el-secretario--notmuch-init  "tag:notdone AND NOT tag:deleted NOT tag:gmail/Inbox"))
       ...
       :next-item-hook (lambda ()
                         (message "next item")))
      (make-el-secretario-source
       :init-function  (lambda () (el-secretario-org-init nil '("~/org/orgzly/InboxComputer.org"
                                                                "~/org/orgzly/Inbox.org") ))
      ...
      (make-el-secretario-source
       :init-function  (lambda ()
                         (el-secretario-org-init '(and (todo "WAITING")
      ...
      (make-el-secretario-source
       :init-function  (lambda ()
                         (el-secretario-org-init '(and (todo)
                                                       (or (todo "PROJ")
                                                           (not (org-entry-blocked-p)))
                                                       (not (tags "weeklyreview" "monthlyreview" "yearlyreview")))
                                                 '("~/org/orgzly/Todo.org"
